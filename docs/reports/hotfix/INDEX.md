...
- [Prompt autonome d’audit fonctionnel d’Imperialism of Promise HOTFIX-6A.17R](_index/HOTFIX_NEXT_MERGE_PHASE_PROMPT.md), sélectionné par la réindexation 6A.17; audit documentaire uniquement, sans correction BIC/Inde.
