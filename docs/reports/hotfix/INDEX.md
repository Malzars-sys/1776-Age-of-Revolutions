...
- [Prompt historique d’audit fonctionnel des API d’événements Coup HOTFIX-6A.16R](_index/HOTFIX_NEXT_MERGE_PHASE_PROMPT.md), conservé comme preuve; aucune phase corrective ne le remplace.
