...
- [Prompt autonome d’audit de l’API historique des intérêts déclarés HOTFIX-6A.18R](_index/HOTFIX_NEXT_MERGE_PHASE_PROMPT.md), sélectionné par la réindexation 6A.18; audit documentaire uniquement, sans correction des cartographies BIC/Inde/GBR/Portugal.
