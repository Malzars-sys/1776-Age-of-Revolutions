...
- Merge global : Russie terminée statiquement; paquet Autriche/Croatie/Suisse clos par `HOTFIX_6A2F2`; prochaine phase `HOTFIX_6A3_DEI_TARGETED_AUDIT`. L’ancien total annoncé de 26 deltas reste `UNVERIFIED`.
