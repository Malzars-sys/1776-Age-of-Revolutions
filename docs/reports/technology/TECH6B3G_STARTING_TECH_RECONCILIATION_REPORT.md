# TECH6B3G â€” Starting Technology Reconciliation Audit

Status: `PASS` Â· `AUDIT_ONLY` Â· `NO_GAMEPLAY_CHANGE`
Reference absolue: `1776-01-01`
Vanilla canonique: `C:\Games\Victoria 3\game` Â· Victoria 3 `1.13.11`

## A. Checkpoint Git

Branche crÃ©Ã©e: `tech6b3g-starting-tech-reconciliation-audit`. Aucun reset, clean, stash, commit ou push. Le worktree TECH6B1â€“F a Ã©tÃ© conservÃ©. Le checkpoint prÃ©-audit comptait 142 entrÃ©es non-TECH6B3G et avait le digest documentaire de contrÃ´le `4a144b8289f3c7a578b3f57afbdde1269ab3f17e2be424df1ece66b4bc4492f2`.

## B. Sources et mÃ©thode

Ordre d'autoritÃ© appliquÃ©: dÃ©cisions utilisateur rÃ©centes, overlay gameplay TECH6B3F, arbre 1776 effectif, setup au `1776-01-01`, puis vanilla 1.13.11 comme provenance mÃ©canique seulement.

Sources internes lues et utilisÃ©es:

- `TECH6B3F_HIDDEN_TECH_RESPONSIBILITY_IMPLEMENTATION_REPORT.md` et sa matrice diffÃ©rÃ©e complÃ¨te (`B3F`);
- `TECH6B3E_HIDDEN_TECH_RESPONSIBILITY_AUDIT_REPORT.md` et sa matrice complÃ¨te (`B3E`);
- `TECH6B3D_TREE_CORRECTION_IMPLEMENTATION_REPORT.md` (`B3D`);
- `TECH6B3C_TREE_HUMAN_REVIEW_REPORT.md` (`B3C`);
- `TECH_TREE_1700_1836_INTEGRATED_V1.md/.csv` et les 285 dÃ©finitions technologiques effectives (`D1`);
- overlay effectif des country histories, comparÃ© sans sensibilitÃ© Ã  la casse (`D2`);
- `C:\Games\Victoria 3\game\common\scripted_effects\00_starting_inventions.txt` (`V1`).

RÃ©fÃ©rences historiques ciblÃ©es:

- `H2` â€” [UK Parliament, crÃ©ation de la Metropolitan Police en 1829](https://www.parliament.uk/about/living-heritage/transformingsociety/laworder/policeprisons/overview/metropolitanpolice/);
- `H3` â€” [Routledge Encyclopedia of Philosophy, apparition du socialisme dans les annÃ©es 1820â€“1830](https://www.rep.routledge.com/articles/thematic/socialism/v-1/sections/defining-socialism);
- `H4` â€” [U.S. Army, origine et gÃ©nÃ©ralisation du corps napolÃ©onien](https://www.armyupress.army.mil/Portals/7/Research-and-Books/Archives/2017/PDF/December-2017-EssentialToSuccess.pdf);
- `H5` â€” [The Mariners' Museum, brevets de propulsion Ã  hÃ©lice de 1836](https://catalogs.marinersmuseum.org/object/CL2749);
- `H6` â€” [Mackinac State Historic Parks, mousquet standard Pattern 1769](https://www.mackinacparks.com/blog/a-short-land-pattern-musket-of-1769/);
- `H7` â€” [Japan Search, anciennetÃ© de la sÃ©riciculture chinoise et japonaise](https://jpsearch.go.jp/en/gallery/ndl-PkaAaPDloqW);
- `H9` â€” [Cambridge, institutions financiÃ¨res et compagnies par actions des XVIIeâ€“XVIIIe siÃ¨cles](https://www.cambridge.org/core/journals/journal-of-economic-history/article/financial-developments-in-london-in-the-seventeenth-century-the-financial-revolution-revisited/C79E018511FBB0F5690DE23F3248123C);
- `H10` â€” exemples institutionnels d'acadÃ©mies techniques avant 1776: [Woolwich 1741, National Army Museum](https://www.nam.ac.uk/explore/sandhurst-officers-and-role-history), [MÃ©ziÃ¨res 1748, MusÃ©e du GÃ©nie](https://www.musee-du-genie-angers.fr/fpdb/20495135-10objets-juillet2024-poursite.pdf) et [Ã©cole ottomane d'ingÃ©nierie navale 1773, Ä°TÃœ](https://mtte.itu.edu.tr/hakkimizda/i-t%C3%BC-tarih%C3%A7esi);
- `H11` â€” [UniversitÃ© de Zurich, surveys et cartes provinciales Tokugawa](https://www.adfontes.uzh.ch/tutorium/old-japanese-maps/surveying);
- `H12` â€” [Oxford Academic, destruction de la flotte marathe en 1756](https://academic.oup.com/reference/62399/reference-article-abstract/555376418);
- `H13` â€” [Cambridge, marine iranienne au XVIIIe siÃ¨cle](https://www.cambridge.org/core/journals/iranian-studies/article/abs/iranian-navy-in-the-gulf-during-the-eighteenth-century/23F5E61D5C986BAED35282716DA32760);
- `H14` â€” [Encyclopaedia Iranica, opÃ©rations et dÃ©pendance navale de la Perse zand](https://www.iranicaonline.org/articles/east-india-company-british-ii-the-afsharid-zand-and-qajar-periods/);
- `H15` â€” [Ã©tude acadÃ©mique des institutions juridiques et administratives du Qing au XVIIIe siÃ¨cle](https://www.jstor.org/stable/jj.17331655).

La recherche externe a Ã©tÃ© rÃ©servÃ©e aux arbitrages qui pouvaient changer l'action. Les autres lignes emploient le design datÃ© du mod et une formulation prudente plutÃ´t qu'une fausse prÃ©cision nationale.
...
Les quatre lignes vanilla PRG (`central_archives`, `egalitarianism`, `empiricism`, `mass_communication`) sont conservÃ©es dans le total obligatoire de 229, mais l'audit constate qu'elles sont shadowÃ©es par `prg - Paraguay.txt` sous le filesystem Windows insensible Ã  la casse. Elles ne sont donc pas des grants runtime effectifs.

## D. Typologie des grants

Les 165 grants directs sont arbitrÃ©s pays par pays. Les 64 grants de tiers sont arbitrÃ©s comme architecture globale. Aucun troisiÃ¨me mÃ©canisme n'est prÃ©sent. Une ligne reÃ§oit exactement une des six actions autorisÃ©es; aucune substitution token-par-token n'est utilisÃ©e.
...
## E. Technologies cachÃ©es concernÃ©es
...
| army_reserves | 1 | â€” | effect_starting_technology_tier_3_tech | corps_organization | era_7 | era_5 |
| artillery | 2 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech | standardized_field_artillery | era_7 | era_3 |
| central_archives | 2 | PRG | effect_starting_technology_tier_1_tech | central_statistical_offices | era_7 | era_5 |
| central_banking | 1 | â€” | effect_starting_technology_tier_1_tech | institutionalized_public_credit | era_7 | era_1 |
...
| currency_standards | 1 | â€” | effect_starting_technology_tier_3_tech | scientific_metrology | era_7 | era_4 |
...
| drydocks | 2 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech | mechanized_naval_dockyards | era_7 | era_5 |
...
| empiricism | 11 | CHL,CLM,GRE,IQU,LAN,NPU,PRG,SPC,SPU,TEX,VNZ | â€” | codified_practical_knowledge | era_7 | era_3 |
| enclosure | 4 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech,effect_starting_technology_tier_6_tech | improved_husbandry | era_4 | era_1 |
| gunsmithing | 2 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech | regulated_small_arms | era_7 | era_2 |
| intensive_agriculture | 1 | â€” | effect_starting_technology_tier_1_tech | advanced_crop_rotations | era_5 | era_3 |
...
| manufacturies | 3 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech | interchangeable_manufacture | era_4 | era_6 |
| mass_communication | 3 | GRE,PRG,SPC | â€” | periodical_print_networks | era_7 | era_1 |
| military_drill | 3 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech | light_infantry_tactics | era_7 | era_3 |
| napoleonic_warfare | 2 | EGY,SPC | â€” | corps_organization | era_7 | era_5 |
| navigation | 3 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech | marine_chronometry | era_7 | era_3 |
| power_of_the_purse | 1 | â€” | effect_starting_technology_tier_1_tech | state_dockyard_systems | era_7 | era_1 |
| prospecting | 2 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech | applied_mineralogy | era_7 | era_3 |
...
| screw_frigate | 1 | â€” | effect_starting_technology_tier_1_tech | iron_hull_construction | era_7 | era_6 |
| sericulture | 4 | CAM,DAI,SIA,WAL | â€” | selective_breeding | era_7 | era_3 |
| standing_army | 4 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech,effect_starting_technology_tier_6_tech | corps_organization | era_7 | era_5 |
| steelworking | 2 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech | puddling_and_rolling | era_7 | era_4 |
...
| urbanization | 4 | â€” | effect_starting_technology_tier_3_tech,effect_starting_technology_tier_4_tech,effect_starting_technology_tier_5_tech,effect_starting_technology_tier_6_tech | paved_roads | era_7 | era_10 |

`psychiatry` ne possÃ¨de aucun Starting Grant dans ce pÃ©rimÃ¨tre (`PSYCHIATRY_STARTING_GRANTS = 0`). La rÃ¨gle d'interdiction `psychiatry â†’ psychoanalysis` reste nÃ©anmoins documentÃ©e pour l'implÃ©mentation future.

## F. Audit des scripted tiers

Le fichier effectif est exclusivement vanilla 1.13.11. L'overlay complet contient 478 country setups: tier 1 = 1, tier 2 = 9, tier 3 = 14, tier 4 = 209, tier 5 = 62, tier 6 = 114, tier 7 = 69. Contrairement au seul sous-ensemble de fichiers du mod, les fichiers vanilla non shadowÃ©s font donc encore usage des tiers 1â€“3.
...
Les 18 grants visibles explicites ci-dessous ne font pas partie des 229 responsabilitÃ©s cachÃ©es et ne sont donc pas ajoutÃ©s aux six compteurs principaux. Ils sont nÃ©anmoins arbitrÃ©s ici pour Ã©viter de reconstruire des tiers qui conserveraient des anachronismes visibles:

| Tier | Visible tech | Category | Current era | Future action | Target | Target era | Reason |
|---|---|---|---|---|---|---|---|
| 1 | railways | production | era_6 | REMOVE_STARTING_GRANT | â€” | â€” | Era 6 and rail transport are not a 1776 starting baseline. |
...
| 1 | general_staff | military | era_6 | REMOVE_STARTING_GRANT | â€” | â€” | The era-6 general-staff system is later than the reference date. |
| 1 | percussion_cap | military | era_5 | REMOVE_STARTING_GRANT | â€” | â€” | Percussion-cap service arms are a 19th-century capability. |
...
| 3 | cotton_gin | production | era_4 | REMOVE_STARTING_GRANT | â€” | â€” | The era-4 node represents the post-1776 mechanized cotton-gin transition. |
| 3 | romanticism | society | era_7 | REMOVE_STARTING_GRANT | â€” | â€” | The post-1836 compatibility node is era 7 and inappropriate at start. |
...
| 3 | colonization | society | era_4 | REMOVE_STARTING_GRANT | â€” | â€” | A global tier grant overstates a polity-specific colonial state capacity. |
...
`add_era_researched = era_1` des tiers 1 et 2 reste une opÃ©ration implicite distincte. Elle devra Ãªtre dÃ©veloppÃ©e en liste explicite ou validÃ©e comme bloc complet pendant TECH6B3H, afin que l'ajout futur de nÅ“uds era 1 ne modifie pas silencieusement les starts.

Constats d'architecture:

- les tiers 3 et 4 surreprÃ©sentent la marine, y compris pour des polities sans littoral;
- plusieurs paires se doublonnent aprÃ¨s migration (`gunsmithing/line_infantry`, `centralization/tech_bureaucracy`, `currency_standards/tech_bureaucracy`);
...
- les tiers donnent parfois un enfant sans tous ses parents. Le moteur accepte un grant recherchÃ© direct; cela ne justifie pas de distribuer automatiquement tous les parents;
- `urbanization` est le seul alias de ce pÃ©rimÃ¨tre dont le grant garde un effet runtime indispensable: il verrouille encore les deux bÃ¢timents urbains diffÃ©rÃ©s.
...
| dialectics | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 1: Neither socialism nor mature dialectical politics belongs in a blanket 1776 starting tier. Reference date is strictly 1776-01-01. |
| egalitarianism | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 1: A blanket advanced-power grant would turn a country-specific revolutionary rights trajectory into a generic capacity. Reference date is strictly 1776-01-01. |
...
| dialectics | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 2: The grant is a vanilla 1836 ideological inheritance; no socialism is justified at 1776-01-01. Reference date is strictly 1776-01-01. |
| egalitarianism | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 2: Rights capacity must be assigned by polity, not granted to an entire tier. Reference date is strictly 1776-01-01. |
...
| admiralty | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: A generic tier includes landlocked polities; naval administration must be country-specific. Reference date is strictly 1776-01-01. |
| army_reserves | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Organized reserves and corps-scale mobilization are later than 1776. Reference date is strictly 1776-01-01. |
...
| democracy | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Constitutional government in 1776 must be polity-specific, not a tier default. Reference date is strictly 1776-01-01. |
| drydocks | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Mechanized dockyards are too late and naval infrastructure cannot be blanket-granted. Reference date is strictly 1776-01-01. |
...
| law_enforcement | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Professional civil policing is an early-19th-century institution and should be country-specific. Reference date is strictly 1776-01-01. |
...
| mandatory_service | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Mass-service organization and corps capacity are post-revolutionary rather than a 1776 baseline. Reference date is strictly 1776-01-01. |
...
| navigation | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Marine chronometry was specialized and a generic tier also contains landlocked countries. Reference date is strictly 1776-01-01. |
...
| standing_army | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: The era-5 corps successor is not a 1776 blanket capacity. Reference date is strictly 1776-01-01. |
...
| urban_planning | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 3: Modern sewerage is far too late and the tier's urbanization alias separately preserves the temporary building gate. Reference date is strictly 1776-01-01. |
...
| Hidden tech | Category | Action | Target | Era | Reason |
|---|---|---|---|---|---|
| admiralty | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Naval administration is not coherent across a 209-country generic tier. Reference date is strictly 1776-01-01. |
...
| democracy | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: A broad tier cannot assign constitutional government accurately in 1776. Reference date is strictly 1776-01-01. |
| drydocks | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Mechanized dockyards are later and naval infrastructure is not universal. Reference date is strictly 1776-01-01. |
...
| international_trade | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Commercial insurance markets are too specific for 209 diverse setups; direct grants should express exceptional trade capacity. Reference date is strictly 1776-01-01. |
...
| navigation | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Marine chronometry and naval navigation are not universal across this tier. Reference date is strictly 1776-01-01. |
| prospecting | production | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Applied mineralogy would overstate a very broad tier; assign it directly where evidenced. Reference date is strictly 1776-01-01. |
...
| standing_army | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Corps organization is post-1800 and cannot be a generic 1776 grant. Reference date is strictly 1776-01-01. |
| steelworking | production | REMOVE_STARTING_GRANT | â€” | â€” | Tier 4: Neither puddling nor a universal coke-smelting capacity is justified across this tier. Reference date is strictly 1776-01-01. |
...
| international_trade | society | REMOVE_STARTING_GRANT | â€” | â€” | Tier 5: Commercial insurance markets are not a safe blanket capacity for this diverse tier. Reference date is strictly 1776-01-01. |
...
| military_drill | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 5: The visible era-3 tactics capacity should be assigned by country at this tier. Reference date is strictly 1776-01-01. |
| navigation | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 5: Marine chronometry is neither universal nor required for every centralized polity. Reference date is strictly 1776-01-01. |
...
| standing_army | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 5: Corps organization is a later capability. Reference date is strictly 1776-01-01. |
...
| standing_army | military | REMOVE_STARTING_GRANT | â€” | â€” | Tier 6: Corps organization is not compatible with the decentralized tier at 1776-01-01. Reference date is strictly 1776-01-01. |
...
RECOMMENDATION = REPLACE_WITH_EARLIER_VISIBLE_TECH â†’ international_relations
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = PARTIAL
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_EARLIER_VISIBLE_TECH â†’ institutionalized_scientific_exchange
CONFIDENCE = MEDIUM
...
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ specialized_technical_academies
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_EARLIER_VISIBLE_TECH â†’ systematic_legal_codification
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ regulated_small_arms
CONFIDENCE = MEDIUM
...
### BIC â€” British East India Company
...
HISTORICAL_FIT_1776 = PARTIAL
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_EARLIER_VISIBLE_TECH â†’ systematic_administrative_statistics
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ selective_breeding
CONFIDENCE = HIGH
...
RECOMMENDATION = ALREADY_REPRESENTED_BY_OTHER_STARTING_TECH â†’ codified_practical_knowledge
CONFIDENCE = MEDIUM
...
### DEI â€” Dutch East Indies Company
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ joint_stock_companies
CONFIDENCE = HIGH
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ periodical_print_networks
CONFIDENCE = MEDIUM
...
RECOMMENDATION = HUMAN_REVIEW_REQUIRED â†’ institutionalized_scientific_exchange
CONFIDENCE = LOW
...
HISTORICAL_FIT_1776 = UNCERTAIN
DUPLICATED_BY_OTHER_STARTING_TECH = YES: multiple effective country files initialize the same tag
RECOMMENDATION = HUMAN_REVIEW_REQUIRED â†’ regulated_small_arms
CONFIDENCE = LOW
RATIONALE = Two distinct mod files ('hubson' and 'hudson') both initialize HBC, so historical intent cannot be separated safely from the duplicate setup. Choose the authoritative country file first; then keep one education/arms grant and remove duplicate or anachronistic service grants.
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ systematic_administrative_statistics
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_EARLIER_VISIBLE_TECH â†’ systematic_cadastral_surveying
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = YES
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = REPLACE_WITH_VISIBLE_TECH â†’ state_dockyard_systems
CONFIDENCE = MEDIUM
...
HISTORICAL_FIT_1776 = UNCERTAIN
DUPLICATED_BY_OTHER_STARTING_TECH = NO
RECOMMENDATION = HUMAN_REVIEW_REQUIRED â†’ state_dockyard_systems
CONFIDENCE = LOW
...
HISTORICAL_FIT_1776 = UNCERTAIN
DUPLICATED_BY_OTHER_STARTING_TECH = YES: multiple effective country files initialize the same tag
RECOMMENDATION = HUMAN_REVIEW_REQUIRED â†’ codified_practical_knowledge
CONFIDENCE = LOW
RATIONALE = Vanilla 'venezuela' and mod 'venezula' are separate effective files and assign conflicting tier-3/tier-4 starts to the same tag. Consolidate the country setup before deciding which one of the overlapping knowledge grants survives.
...
## H. Grants Ã  remplacer directement
...
Les remplacements directs sont limitÃ©s aux concepts dont le propriÃ©taire visible correspond au rÃ´le initial et dont la capacitÃ© est dÃ©fendable au 1776-01-01: armes rÃ©glementÃ©es, artillerie standardisÃ©e, connaissances codifiÃ©es, sÃ©riciculture, acadÃ©mies documentÃ©es et quelques capacitÃ©s navales prÃ©cises.

## I. Grants Ã  remplacer par un nÅ“ud plus ancien
...
Cette catÃ©gorie Ã©vite notamment `professional_civil_policing`, `corps_organization`, `iron_hull_construction`, `interchangeable_manufacture` et `modern_sewerage`. Les cibles sont des abstractions visibles plus anciennes et de mÃªme catÃ©gorie.

## J. Grants Ã  supprimer
...
Les suppressions couvrent les hÃ©ritages 1836 sans capacitÃ© 1776 suffisante, les concepts globalement trop spÃ©cifiques pour un tier, les grants napolÃ©oniens/socialistes anachroniques et les quatre occurrences vanilla PRG inactives.

## K. Grants dÃ©jÃ  couverts

Nombre = 17
Indices matrice = 059, 061, 062, 064, 065, 066, 078, 079, 080, 081, 082, 083, 085, 086, 087, 093, 197

Les doublons sont explicitement reliÃ©s Ã  `add_era_researched = era_1`, Ã  une autre ligne du mÃªme tier, ou au remplacement tier-level `rationalism â†’ codified_practical_knowledge`.

## L. Aliases Ã  conserver exceptionnellement

Nombre = 4
Indices matrice = 226, 227, 228, 229

Les quatre lignes sont exclusivement `urbanization` dans les tiers 3â€“6. Cette conservation est temporaire et strictement motivÃ©e par `building_urban_center` et `building_construction_sector`. Aucun autre alias de ce pÃ©rimÃ¨tre ne conserve un effet runtime non-starting.

## M. Technologies tardives proposÃ©es au start
...
L'unique proposition tardive est `DEI â†’ joint_stock_companies` (era 6). L'exception est volontaire: la VOC est prÃ©cisÃ©ment une compagnie Ã  charte et capital-actions, ce qui dÃ©montre que l'era globale du nÅ“ud dÃ©crit mal ce pionnier particulier. Aucun target era 8+ n'est proposÃ©.

## N. Cas historiques recherchÃ©s

- `dialectics`: les trois grants sont supprimÃ©s; aucune conversion vers `socialism` n'est proposÃ©e, le vocabulaire et les mouvements socialistes se consolidant au XIXe siÃ¨cle (`H3`).
- `law_enforcement`: la police civile professionnelle est traitÃ©e comme postÃ©rieure Ã  1776 (`H2`); les polities Ã  ordre lÃ©gal codifiÃ© reÃ§oivent un owner juridique plus ancien, les autres perdent le grant.
- `napoleonic_warfare`, reserves et mandatory service: le corps opÃ©rationnel relÃ¨ve de la pÃ©riode rÃ©volutionnaire/napolÃ©onienne et postÃ©rieure (`H4`).
- `screw_frigate`: les brevets dÃ©cisifs datent de 1836 (`H5`); seule l'architecture navale scientifique antÃ©rieure est proposÃ©e au tier 1.
- `line_infantry`: le Pattern 1769 confirme la cohÃ©rence d'une abstraction d'armes rÃ©glementÃ©es Ã  la date de rÃ©fÃ©rence (`H6`).
- sÃ©riciculture asiatique: tradition ancienne, donc remplacement par l'owner visible du throughput et non suppression (`H7`).
...
- Marathes/Perse: la flotte marathe subsiste comme capacitÃ© limitÃ©e malgrÃ© 1756 (`H12`); la Perse zand reste ambiguÃ« entre projet naval propre et dÃ©pendance Ã  la compagnie (`H13`, `H14`).
- DEI: les compagnies par actions sont attestÃ©es bien avant 1776, justifiant l'unique exception era 6 (`H9`).
...
SCOPE = COUNTRY
COUNTRY = HBC â€” Hudson Bay Company
...
ERA = era_1; era_2
WHY = `hubson bay company.txt` et `hudson bay company.txt` initialisent tous deux `c:HBC`; l'intention canonique n'est pas dÃ©ductible sans choisir le fichier autoritaire.
ALTERNATIVE = conserver les deux fichiers et ne dÃ©dupliquer que les grants identiques
CONSEQUENCE_RECOMMENDED = setup unique, aucun double grant, aucune conscription anachronique
CONSEQUENCE_ALTERNATIVE = double initialisation HBC conservÃ©e et risque de divergences futures
CONFIDENCE = LOW

[START-02]

SCOPE = COUNTRY
COUNTRY = VNZ â€” Venezuela
...
PROPOSED_ACTION = consolider vers le fichier mod/canonique choisi puis conserver une seule capacitÃ© de connaissance
PROPOSED_TARGET = codified_practical_knowledge ou institutionalized_scientific_exchange selon le setup retenu
ERA = era_3 ou era_1
WHY = les noms ne diffÃ¨rent pas seulement par la casse; les deux fichiers sont effectifs et assignent deux tiers concurrents au mÃªme tag.
ALTERNATIVE = maintenir les deux blocs et accepter le cumul tier 3 + tier 4
CONSEQUENCE_RECOMMENDED = un seul profil technologique 1776 cohÃ©rent
CONSEQUENCE_ALTERNATIVE = sur-attribution massive et ordre de setup difficile Ã  raisonner
CONFIDENCE = LOW

[START-03]

SCOPE = COUNTRY
COUNTRY = PER â€” Perse zand
CURRENT_GRANT = admiralty
HIDDEN_TECH = admiralty
PROPOSED_ACTION = HUMAN_REVIEW_REQUIRED
PROPOSED_TARGET = state_dockyard_systems
ERA = era_1
WHY = la Perse mÃ¨ne des opÃ©rations du Golfe et recherche du soutien naval, mais les sources ne tranchent pas clairement entre capacitÃ© Ã©tatique propre durable et dÃ©pendance aux navires de la Compagnie.
ALTERNATIVE = REMOVE_STARTING_GRANT
CONSEQUENCE_RECOMMENDED = reconnaÃ®t une capacitÃ© navale zand limitÃ©e
CONSEQUENCE_ALTERNATIVE = Ã©vite de surestimer l'institutionnalisation navale
CONFIDENCE = LOW

## P. Plan d'implÃ©mentation futur

`TECH6B3H_STARTING_TECH_RECONCILIATION_IMPLEMENTATION` devra:

1. rÃ©soudre START-01 Ã  START-03;
2. crÃ©er un override mod de `00_starting_inventions.txt` reconstruit par tier et catÃ©gorie, en appliquant aussi l'audit des 18 grants dÃ©jÃ  visibles et en explicitant/gelant les `add_era_researched`, sans substitution brute;
3. appliquer les dÃ©cisions directes dans les country histories effectives seulement;
4. dÃ©dupliquer les targets visibles par country aprÃ¨s expansion du tier;
5. conserver temporairement `urbanization`, puis le retirer lorsque les deux gates bÃ¢timents auront un owner visible approuvÃ©;
6. exÃ©cuter validation statique, smoke launch et revue visuelle de l'arbre dans une phase distincte.

NEXT_PHASE_READY = NO tant que les trois paquets START ne sont pas arbitrÃ©s.
...
Tous les targets existent. Tous sont visibles/recherchables et de mÃªme catÃ©gorie, sauf `urbanization`, explicitement conservÃ© comme alias non recherchable pour compatibilitÃ© runtime. Les trois lignes `HUMAN_REVIEW_REQUIRED` de groupes comptent 8 grants individuels.

## R. Aucun changement gameplay

Cette phase a crÃ©Ã© uniquement les trois documents TECH6B3G. Elle n'a modifiÃ© aucun fichier sous `common/`, `events/`, `gui/` ou `localization/`.
...
## Addendum TECH6B3H â€” arbitrages utilisateur dÃ©sormais rÃ©solus

Cet addendum ne rÃ©Ã©crit pas le constat historique de l'audit. Il enregistre les dÃ©cisions utilisateur ultÃ©rieures appliquÃ©es par TECH6B3H et remet la matrice TECH6B3G en cohÃ©rence avec elles.

- `START-01 HBC = APPROVED` : consolidation vers l'unique fichier canonique `hbc - hudson bay company.txt`; `institutionalized_scientific_exchange` est conservÃ©e une fois; `regulated_small_arms` est fournie une fois par le tier 4 rÃ©conciliÃ©; `mandatory_service` est supprimÃ©e.
- `START-02 VNZ = APPROVED` : le setup du mod est conservÃ© sous le nom canonique exact `vnz - venezuela.txt`, ce qui neutralise le setup vanilla concurrent; le Venezuela n'est pas prÃ©sent au lancement 1776 parce que la Nouvelle-Grenade dÃ©tient alors ces territoires; aucune double attribution tier 3/tier 4 ne subsiste.
- `START-03 PER = APPROVED` : `admiralty` est remplacÃ©e par `state_dockyard_systems` pour la Sublime Zand.

Les huit lignes individuelles auparavant marquÃ©es `HUMAN_REVIEW_REQUIRED` ont Ã©tÃ© converties dans `TECH6B3G_STARTING_TECH_RECONCILIATION_MATRIX.csv` vers leurs actions finales. La matrice tier ne contenait aucun arbitrage humain et reste inchangÃ©e.
